...
def board(board_id):
    try:
        ...
        logging.error(f"Board view error: {str(e)}")
        flash('An error occurred loading the board.')
        return redirect(url_for('boards'))
...
def reminders():
    try:
        ...
        logging.error(f"Reminders error: {str(e)}")
        flash('An error occurred loading reminders.')
        return redirect(url_for('boards'))